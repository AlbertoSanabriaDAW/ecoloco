...
(
    ...
    constraint fk_perfil_usuario foreign key
(
    id_usuario
) references usuario
(
...
(
    ...
    constraint fk_aptitud_perfil_aptitud foreign key
(
    id_aptitud
) references aptitud
(
...
(
    ...
    constraint fk_aptitud_evento_aptitud foreign key
(
    id_aptitud
) references aptitud
(
...
(
    ...
    constraint fk_usuario_evento_usuario foreign key
(
    id_usuario
) references usuario
(
...
INSERT INTO usuario (id, username, password, email, rol)
VALUES (1, 'jgarcia', 'pass123', 'jgarcia@example.com', 1),
...
INSERT INTO perfil (id, nombre, apellidos, telefono, dni, fecha_nacimiento, id_usuario)
VALUES (1, 'Juan', 'García', '612345678', '12345678A', '1985-06-12', 1),
...
INSERT INTO aptitud (id, nombre, tipo)
VALUES (1, 'Jardinería', 1),
       (2, 'Conducción', 2),
...
INSERT INTO evento (id, titulo, fecha, ubicacion, descripcion, imagen)
VALUES (1, 'Reforestación ecoloca', '2023-09-15', 'Madrid', 'Evento de reforestación', 'foto.png'),
...
INSERT INTO aptitud_perfil (id, id_aptitud, id_perfil)
VALUES (1, 1, 1),
       (2, 3, 1),
       (3, 2, 2),
       (4, 4, 3),
...
INSERT INTO aptitud_evento (id, id_aptitud, id_evento)
VALUES (1, 1, 1),
       (2, 3, 2),
       (3, 4, 3),
       (4, 1, 4);
...
INSERT INTO usuario_evento (id, id_usuario, id_evento)
VALUES (1, 1, 1),
       (2, 3, 1),
       (3, 2, 2),
       (4, 3, 3),
