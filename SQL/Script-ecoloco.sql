...
INSERT INTO evento (id, titulo, fecha, ubicacion, descripcion, imagen, id_usuario) VALUES
(1, 'Reforestación ecoloca','2023-09-15', 'Madrid', 'Evento de reforestación', 'foto.png', 1),
(2, 'Curso primeros auxilios','2023-10-01', 'Barcelona', 'Taller de primeros auxilios', 'foto.png', 2),
(3, 'Ecoloco distribuyendo comida','2023-11-20', 'Valencia', 'Distribución de alimentos', 'foto.png', 3),
(4, 'Ecoloco garden','2023-12-10', 'Sevilla', 'Taller de jardinería urbana', 'foto.pnj', 4);
